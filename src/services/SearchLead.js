...
export const SearchLead = (searchString, query) => {
  return new Promise((resolve, reject) => {
    net.search(
      ...
      //   :
      `FIND {${searchString}} IN ALL FIELDS RETURNING Lead(Id, Name,FirstName,LastName, Status, LeadSource, Lead_Id__c,CreatedDate,LeadIdFormula__c,Branch_Name__c,Channel_Name__r.Name ORDER BY LASTMODIFIEDDATE DESC)`,
      (res) => {
        resolve(res);
