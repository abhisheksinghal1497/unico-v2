...
export default function MeetingList({ navigation }) {
  ...
  const renderItem = ({ item }) => {
    let formatedDate = format(item.StartDateTime, "dd/MM/yyyy");
    let formatedStartTime = format(item.StartDateTime, "hh:mm a");
    let formatedEndTime = format(item.EndDateTime, "hh:mm a");
