...
let syncDownName = soupConfig.userInfo.syncDownName;

const soupName = soupConfig.userInfo.soupName;

const SMARTSTORE_CHANGED = soupConfig.userInfo.SMARTSTORE_CHANGED;

const objectName = soupConfig.userInfo.objectName;
